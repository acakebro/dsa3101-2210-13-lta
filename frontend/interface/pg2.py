...
d_exp_cam = {
        ...
        'Changi': ['1001', '1002', '1003', '1703', '2703', '3704', '3793', '3796','3797', '3798', '4702',
                   '5794', '5795', '5797', '5798', '5799','6701', '6703', '6704', '6705', '6706', '6708',
                   '6710', '6712','6713', '6714', '6715', '6716'],
        ...
        'Jurong' : ['2703', '4701', '4702', '4705', '4706', '4709', '4710', '4714','4716', '5794', '5795',
                    '5797', '5798', '5799', '6701', '6703','6704', '6705', '6706', '6710', '6711', '6712', '6713'],
...
layout = html.Div(
    ...
    html.Div(
        children=[
        html.H6('Road', style={'font-weight': 'bold'}),
        dcc.Dropdown(id='road_name',
                     options=road_options(d_exp_cam),
                     placeholder='KPE',
                     style={'width':'150px','margin':'0 auto'})
        ],
        style = {'marginLeft':'650px','width':'18%','display':'flex','align-items':'center','justify-content':'center'}
        ),
    ...
    html.Div(
        ...
        html.Div(
            children=[
            html.H6('Camera ID', style={'font-weight': 'bold'}),
        ...
        html.Div(
            children=[
            html.H6('Date', style={'font-weight': 'bold'}),
        ...
        html.Div(
            children=[
            html.H6('Time', style={'font-weight': 'bold'}),
            dcc.Input(id="traffic_time",
                      type="text",
                      placeholder="HHMM",
                      style = {'display': 'inline-block', 'width':'150px','height':'30px','margin':'0 auto', 'fontSize': '15px'}
                      )
            ], style ={'width':'400px'}),
        
        ],
        style = {'marginLeft': '100px','width':'100%','display':'flex','align-items':'center','justify-content':'center'}
        ),
    ...
    html.Div(
            ...
            html.Div(
                children=[
                html.H6('Direction:', style={'font-weight': 'bold'}),
                html.H6('Density:', style={'font-weight': 'bold'}),
                html.H6('Speed:', style={'font-weight': 'bold'}),
                html.H6('Traffic condition:', style={'font-weight': 'bold'}),
                ],
    ...
    html.Div(children = [
        html.Div(children = [
            html.H5('Past data analysis', style={'font-weight': 'bold'}),
    ...
    html.Div(children = [
            html.H5('Congested areas (> 2 hours of continuous jam)',
                    style={'font-weight': 'bold'}
                    ),
            html.Div(id = 'places')
            ],
            style = {'width': '100%','marginLeft':'550px','align-items':'center','justify-content':'center'}
            ),
    ],
