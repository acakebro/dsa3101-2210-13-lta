...
app.display(name='title', value="Singapore's Road Map")
app.display(name='description',
            value='Display of road and camera data')

text_1 = """
## About the map
The dashboard shows the boundaries of the regions of Singapore as polygons, 
the major arterial higways as lines and the cameras of each road as points.
"""
